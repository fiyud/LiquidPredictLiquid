"""Full assembly of U-Net with C3STR bottleneck + PosEnc and Hybrid Activations."""
...
class UNet(nn.Module):
    def __init__(self,
        ...
        # Encoder (ReLU mặc định để ổn định)
        ...
        # Bottleneck dùng C3STR (giữ C3STR, chỉ bổ sung PE + dropout)
