...
class LiquidTimeConstantScaler(nn.Module):
    """
    LTC-based dynamic scaling factor cho Mamba's selective SSM.
    Sử dụng time-constant dynamics để điều chỉnh state selection theo thời gian.
    """
    def __init__(
        self, 
        d_model: int, 
...
if __name__ == "__main__":
    print("Testing Liquid Mamba Attention Mechanisms...")
    ...
    # Test liquid dynamics over time
    ...
    # Compare với standard attention (concept)
    ...
    # Test với different sequence lengths
    print("\n=== Testing scalability ===")
